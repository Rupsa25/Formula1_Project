...
lap_times_df=spark.read \
    ...
    .csv(f"/mnt/formula1dllatest/raw/{v_file_date}/lap_times")
...
merge_delta_data(final_df,"f1_processed","lap_times",processed_folder_path,"race_id",merge_condition)

# COMMAND ----------

display(spark.read.format("delta").load("/mnt/formula1dllatest/processed/lap_times"))
...
display(dbutils.fs.ls("/mnt/formula1dllatest/processed"))
