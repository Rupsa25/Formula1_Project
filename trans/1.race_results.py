...
# incremental_load(final_df,"f1_presentation","race_results","race_id")
merge_condition="tgt.driver_name=src.driver_name AND tgt.race_id=src.race_id"
merge_delta_data(final_df,"f1_presentation","race_results",presentation_folder_path,"race_id",merge_condition)
...
# MAGIC %sql
# MAGIC SELECT DISTINCT(race_year) FROM f1_presentation.race_results ORDER BY 1 DESC;

# COMMAND ----------

# MAGIC %sql
# MAGIC DESC EXTENDED f1_presentation.race_results;
